...
const BrieflyCard = ({city, weather}: Props) => {
        ...
        <div className="flex justify-center gap-x-6 md:gap-x-10 my-8">
            <div className="flex flex-col justify-end items-center">
                ...
                <span className="text-xs md:text-sm text-center font-bold text-blue-400 dark:text-gray-300">
                    {t('forecastsCard.briefly_weather.feelsLike')}
            ...
            <div className="flex flex-col justify-end items-center">
                ...
                {weather?.current?.weathercode && <span className="text-xs md:text-sm text-center font-bold text-blue-400 dark:text-gray-300">{t(`weathercodes.${weather.current.weathercode}`)}</span>}
        ...
        <div className="flex flex-col md:flex-row items-center md:justify-between mt-10">
            <div className="flex">
                ...
                {weather?.daily?.sunrise[0] && (
                    <span className="text-xs">
                        {t('forecastsCard.briefly_weather.sunrise.title')}
                        {t(
                            'forecastsCard.briefly_weather.sunrise.time',
                            {
            ...
            <div className="flex">
                ...
                {weather?.daily?.sunset[0] && (
                    <span className="text-xs">
                        {t('forecastsCard.briefly_weather.sunset.title')}
                        {t(
                            'forecastsCard.briefly_weather.sunset.time',
                            {
