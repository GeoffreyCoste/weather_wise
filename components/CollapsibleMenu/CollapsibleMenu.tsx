...
const CollapsibleMenu = ({temperatureCookie}: Props) => {
      ...
      <LazyMotion features={domAnimation}>
        <AnimatePresence>
          {isMenuOpen && (
            <m.div
              ref={menuRef}
              className={`absolute end-0 z-20 mt-2 flex w-56 flex-col items-center rounded-md p-4 ${
            ...
            >
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    ...
                    <path
                      ...
                      stroke={
                        themeState.theme === 'light' ? '#1d4ed8' : '#dbeafe'
                      }
                      strokeWidth="2.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              >
                {t('header.collapsible_menu.title')}
              </h3>
              <h4
              ...
              >
                {t('header.collapsible_menu.label_language')}
              </h4>
              ...
              >
                {t('header.collapsible_menu.label_degrees')}
              </h4>
